 ...
 */
var ImagedetailPage = /** @class */ (function () {
    function ImagedetailPage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    ImagedetailPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad ImagedetailPage');
    };
    ImagedetailPage = __decorate([
        IonicPage(),
        Component({
